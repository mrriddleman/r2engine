...
void main()
{
	...
	DefaultWorldMaterialFunction(fs_in.fragPos, fs_in.drawID, fs_in.materialIndex, fs_in.texCoords0, fs_in.texCoords1, fs_in.TBN, fs_in.tangent, fs_in.normal, pixel);
