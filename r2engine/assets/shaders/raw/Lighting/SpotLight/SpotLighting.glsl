...
vec3 EvalSpotLightNoClearCoatNoAnisotropy(SpotLight spotLight, in PixelData pixel)
{
	vec3 posToLight = spotLight.position.xyz - pixel.worldFragPos;
...
void EvalAllSpotLightsNoClearCoatNoAnisotropy(uint clusterTileIndex, inout vec3 L0, in PixelData pixel)
{
	uint spotLightCount = lightGrid[clusterTileIndex].spotLightCount;
	...
	for(int i = 0; i < spotLightCount; ++i)
	{
		...
		vec3 lightingResult = EvalSpotLightNoClearCoatNoAnisotropy(spotLight, pixel);
...
vec3 EvalSpotLightWithClearCoat(SpotLight spotLight, in PixelData pixel)
{
	vec3 posToLight = spotLight.position.xyz - pixel.worldFragPos;
...
void EvalAllSpotLightsWithClearCoat(uint clusterTileIndex, inout vec3 L0, in PixelData pixel)
{
	uint spotLightCount = lightGrid[clusterTileIndex].spotLightCount;
	...
	for(int i = 0; i < spotLightCount; ++i)
	{
		...
		vec3 lightingResult = EvalSpotLightWithClearCoat(spotLight, pixel);
...
vec3 EvalSpotLightWithAnisotropy(SpotLight spotLight, in PixelData pixel)
{
	vec3 posToLight = spotLight.position.xyz - pixel.worldFragPos;
...
void EvalAllSpotLightsWithAnisotropy(uint clusterTileIndex, inout vec3 L0, in PixelData pixel)
{
	uint spotLightCount = lightGrid[clusterTileIndex].spotLightCount;
	...
	for(int i = 0; i < spotLightCount; ++i)
	{
		...
		vec3 lightingResult = EvalSpotLightWithAnisotropy(spotLight, pixel);
