...
namespace r2::ecs
{
	...
	template<>
	inline void DeSerializeComponentArray(r2::SArray<AudioListenerComponent>& components, const r2::SArray<Entity>* entities, const r2::SArray<const flat::EntityData*>* refEntities, const flat::ComponentArrayData* componentArrayData)
	{
