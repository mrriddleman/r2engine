...
#else
					auto assetName = flat::CreateAssetNameDirect(fbb, 0, materialOverride.assetName.hashID, "");
					auto packAssetName = flat::CreateAssetNameDirect(fbb, 0, materialOverride.packName.hashID, "");
#endif					
