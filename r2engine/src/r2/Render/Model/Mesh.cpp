...
namespace r2::draw
{
    u64 Mesh::MemorySize(u64 numVertices, u64 numIndices, u64 alignment, u64 headerSize, u64 boundsChecking)
    {
        return
            r2::mem::utils::GetMaxMemoryForAllocation(sizeof(r2::draw::Mesh), alignment, headerSize, boundsChecking) +
