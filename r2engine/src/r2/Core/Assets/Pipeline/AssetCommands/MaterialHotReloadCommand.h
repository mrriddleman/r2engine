...
namespace r2::asset::pln
{
	...
	public:
		...
		static bool MaterialManifestHotReloaded(const std::vector<std::string>& paths, const std::string& manifestFilePath, const byte* manifestData, r2::asset::HotReloadType type);
