#ifdef R2_EDITOR
#ifndef __INSPECTOR_PANEL_POINT_LIGHT_COMPONENT_H__
#define __INSPECTOR_PANEL_POINT_LIGHT_COMPONENT_H__
...
namespace r2::edit
{
	...
	class InspectorPanelPointLightDataSource : public InspectorPanelComponentDataSource
	{
	public:
		InspectorPanelPointLightDataSource();
		InspectorPanelPointLightDataSource(r2::Editor* noptrEditor, r2::ecs::ECSCoordinator* coordinator, const InspectorPanel* inspectorPanel);
